...
function App() {
  ...
  // ========================================
  // Auth Gate — Se não logado, mostra tela de login
  // ========================================
  if (!user) {
    return <AuthScreen />;
  }
  ...
  // ========================================
  // Group View — Se um grupo está ativo
  // ========================================
  if (activeGroup) {
    return (
      <>
  ...
  // ========================================
  // Personal View (abaixo)
  // ========================================
  return <PersonalView />;

  // ========================================
  // Componente interno — Vista pessoal (calendário original)
  // ========================================
  function PersonalView() {
    ...
    const handleDeleteDate = async (dateId) => {
      ...
      setCoverPhotos((prev) => { const updated = { ...prev }; delete updated[dateId]; return updated; });
    ...
    const handleCoverChange = (dateId, dataUrl) => {
      setCoverPhotos((prev) => {
        const updated = { ...prev };
        if (dataUrl) { updated[dateId] = dataUrl; } else { delete updated[dateId]; }
        return updated;
      });
    };
    ...
    return (
      <>
        ...
        <GroupsPanel
          ...
          onSelectGroup={(group) => { setShowGroupsPanel(false); setActiveGroup(group); }}
        />
